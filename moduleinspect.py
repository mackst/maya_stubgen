...
class ModuleInspect(object):
    ...
    # def __init__(self, max_workers=None, useProcess=False) -> None:
    #     self.__executorClass = ThreadPoolExecutor
    #     if useProcess:
    #         self.__executorClass = ProcessPoolExecutor
        
    #     self.max_workers = max_workers

    def get_package_properties(self, package_id: str) -> ModuleProperties:
        # with self.__executorClass(max_workers=self.max_workers) as executor:
        #     pass
